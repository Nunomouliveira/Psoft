# US 011 - As subscriber I want to add a new device to my subscription
...
> **Question#6:** "...quando o subscritor quer adicionar um novo dispositivo os atributos inseridos têm algum criterio de aceitação?"
>
